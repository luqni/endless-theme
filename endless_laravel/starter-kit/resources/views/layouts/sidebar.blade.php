...
<div class="page-sidebar">
  ...
  <div class="sidebar custom-scrollbar">
    ...
    <ul class="sidebar-menu">
      <li><a class="sidebar-header" href="{{route('/')}}" target="_blank"><i data-feather="home"></i><span>Dashboard</span></a></li>
      <li class="active"><a class="sidebar-header" href="#"><i data-feather="anchor"></i><span>Starter Kit</span><i class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          <li class="active"><a href="#"><i class="fa fa-circle"></i>color version<i class="fa fa-angle-down pull-right"></i></a>
            <ul class="sidebar-submenu">
              <li><a class="active" href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Layout Light</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Layout Dark</a></li>
            </ul>
          </li>
          <li><a href="#"><i class="fa fa-circle"></i>Sidebar<i class="fa fa-angle-down pull-right"></i></a>
            <ul class="sidebar-submenu">
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Light Sidebar</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Compact Sidebar</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Compact Icon Sidebar</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Dark Sidebar</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Sidebar Hidden</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Sidebar Fixed</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Sidebar With Image</a></li>
          ...
          <li><a href="#"><i class="fa fa-circle"></i>Page layout<i class="fa fa-angle-down pull-right"></i></a>
            <ul class="sidebar-submenu">
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Boxed</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>RTL</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>1 Column</a></li>
            </ul>
          </li>
          <li><a href="#"><i class="fa fa-circle"></i>Menu Options<i class="fa fa-angle-down pull-right"></i></a>
            <ul class="sidebar-submenu">
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Hide menu on Scroll</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Vertical Menu</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Mega Menu</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Fix Header</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Fix Header & Sidebar                </a></li>
            </ul>
          </li>
          <li><a href="#"><i class="fa fa-circle"></i>Footers<i class="fa fa-angle-down pull-right"></i></a>
            <ul class="sidebar-submenu">
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Footer Light</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Footer Dark</a></li>
              <li><a href="{{route('inner-page')}}"><i class="fa fa-circle"></i>Footer Fixed                                </a></li>
            </ul>
          </li>
        </ul>
      </li>
      ...
      <li><a class="sidebar-header" href="{{route('inner-page')}}" target="_blank"><i data-feather="file-text"></i><span>Documentation</span></a></li>
    </ul>
  </div>
</div>
<!-- Page Sidebar Ends-->
