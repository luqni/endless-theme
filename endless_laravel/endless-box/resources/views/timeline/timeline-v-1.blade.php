...
@section('title', 'Timeline 1 | Endless - Premium Admin Template')
@section('style')
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/animate.css')}}">
@endsection

@section('breadcrumb-title', 'Timeline 1')
        ...
        <div class="card-body">
          ...
          <section class="cd-container" id="cd-timeline">
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                <h4>Title of section<span class="digits"> 3</span></h4><img class="img-fluid p-t-20" src="{{asset('assets/images/banner/1.jpg')}}" alt=""><span class="cd-date">Jan <span class="counter digits">24</span></span>
              </div>
            </div>
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                ...
                <audio class="m-t-20" controls="">
                  <source src="{{asset('assets/audio/horse.ogg')}}" type="audio/ogg">                                                Your browser does not support the audio element.
            ...
            <div class="cd-timeline-block">
              ...
              <div class="cd-timeline-content">
                <h4>Title of section<span class="digits"> 5</span></h4><img class="img-fluid p-t-20" src="{{asset('assets/images/banner/3.jpg')}}" alt=""><span class="cd-date">Feb <span class="counter digits">18</span></span>
              </div>
            </div>
            <div class="cd-timeline-block">
