...
@section('title', 'Email Application | Endless - Premium Admin Template')
@section('style')

@endsection

@section('breadcrumb-title', 'Email Application')
...
<div class="container-fluid">
  <div class="email-wrap">
    <div class="row">
      <div class="col-xl-3 col-md-6 set-col-12">
      ...
      <div class="col-xl-3 col-md-6 set-col-4">
      ...
      <div class="col-xl-6 col-md-12 set-col-8">
        <div class="email-right-aside">
                    ...
                    <div class="email-top">
                      <div class="row">
                        <div class="col-md-6 xl-100 col-sm-12">
                          <div class="media"><img class="mr-3 rounded-circle" src="{{asset('assets/images/user/user.png')}}" alt="">
                            <div class="media-body">
                        ...
                        <div class="col-md-6 col-sm-12">
                          <div class="float-right d-flex">
                            <p class="user-emailid">Lormlpsa<span class="digits">23</span>@company.com</p><i class="fa fa-star-o f-18 mt-1"></i>
                          </div>
                        </div>
                      </div>
                    </div>
