...
@section('title', 'Chat App | Endless - Premium Admin Template')
@section('style')

@endsection

@section('breadcrumb-title', 'Chat App')
        ...
        <div class="card-body chat-body">
          <div class="chat-box">
            ...
            <div class="chat-left-aside">
              <div class="media"><img class="rounded-circle user-image" src="{{asset('assets/images/user/12.png')}}" alt="">
                <div class="about">
            ...
            <div class="col pr-0 chat-right-aside">
              ...
              <div class="chat">
                ...
                <div class="chat-history chat-msg-box custom-scrollbar">
                  <ul>
                    <li>
                      <div class="message my-message"><img class="rounded-circle float-left chat-user-img img-30" src="{{asset('assets/images/user/3.png')}}" alt="">
                    ...
                    <li class="clearfix">
                      <div class="message other-message pull-right"><img class="rounded-circle float-right chat-user-img img-30" src="{{asset('assets/images/user/12.png')}}" alt="">
                    ...
                    <li>
                      <div class="message my-message mb-0"><img class="rounded-circle float-left chat-user-img img-30" src="{{asset('assets/images/user/3.png')}}" alt="">
                ...
                <div class="tab-pane fade show active" id="info-home" role="tabpanel" aria-labelledby="info-home-tab">
                  <div class="people-list">
                    <ul class="list digits">
                      ...
                      <li class="clearfix"><img class="rounded-circle user-image mt-0" src="{{asset('assets/images/user/1.jpg')}}" alt="">
                        <div class="about">
