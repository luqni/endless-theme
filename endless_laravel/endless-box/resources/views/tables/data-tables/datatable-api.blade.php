...
@section('title', 'API DataTables | Endless - Premium Admin Template')
@section('style')
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Add rows </h5><span>New rows can be added to a DataTable using the<code class="api" title="DataTables API method">row.add()</code> API method. Simply call the API function with the data for the new row (be it an array or object). Multiple rows
