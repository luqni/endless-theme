...
@section('title', 'Social App | Endless - Premium Admin Template')
@section('style')
...
<div class="user-profile social-app-profile">
  ...
  <div class="tab-content" id="top-tabContent">
    <div class="tab-pane fade show active" id="timeline" role="tabpanel" aria-labelledby="timeline">
      <div class="row">
        <div class="col-xl-3 xl-40 col-lg-12 col-md-5 set-col-5">
        ...
        <div class="col-xl-6 xl-60 col-lg-12 col-md-7 set-col-7">
          <div class="row">
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
