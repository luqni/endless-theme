...
@section('title', 'Basic Card | Endless - Premium Admin Template')
@section('style')
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/prism.css')}}">
@endsection

@section('breadcrumb-title', 'Basic Card')
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
    ...
    <div class="col-sm-12 col-xl-6">
      <div class="card height-equal">
        ...
        <div class="card-body">
          <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the the industry's standard dummy text ever.</p>
        </div>
