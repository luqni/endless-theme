          ...
          <td>
                ...
                <tr>
                  <td>
                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr>
                          <td><img src="{{asset('assets/images/endless-logo.png')}}" alt=""></td>
              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>you forgot your password for Endless Admin. If this is true, click below to reset your password.</p>
                    <p style="text-align: center"><a href="#" style="padding: 10px; background-color: #4466f2; color: #fff; display: inline-block; border-radius: 4px">Reset Password</a></p>
            ...
            <table style="width: 650px; margin: 0 auto; margin-top: 30px; text-align: center">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="font-size:13px; margin:0;">2019 - 20 Copy Right by Themeforest powerd by Pixel Strap</p>
                  </td>
                </tr>
                <tr>
