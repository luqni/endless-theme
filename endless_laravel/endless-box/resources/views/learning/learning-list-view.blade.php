...
@section('title', 'Learning List | Endless - Premium Admin Template')
@section('style')

@endsection

@section('breadcrumb-title', 'Learning List')
  ...
  <div class="row">
    <div class="col-xl-9 xl-60 set-col-7">
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <div class="blog-box blog-list row product-box">
              <div class="col-sm-5 product-img"><img class="img-fluid sm-100-w" src="{{asset('assets/images/faq/1.jpg')}}" alt="">
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="blog-box blog-list row product-box">
              <div class="col-sm-5 product-img"><img class="img-fluid sm-100-w" src="{{asset('assets/images/faq/2.jpg')}}" alt="">
                <div class="product-hover">
                  <ul>
                    <li><i class="icon-link"></i></li>
                    <li><i class="icon-import"></i></li>
        ...
        <div class="col-xl-4 xl-50 col-sm-6 set-col-6">
          <div class="card">
