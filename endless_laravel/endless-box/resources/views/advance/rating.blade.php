...
@section('title', 'Rating | Endless - Premium Admin Template')
@section('style')
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/rating.css')}}">
@endsection

@section('breadcrumb-title', 'Rating')
            ...
            <div class="star-ratings">
              <div class="stars stars-example-fontawesome-o">
                <select id="u-rating-fontawesome-o" name="rating" data-current-rating="5.6" autocomplete="off">
                  ...
                  <option value="9">9</option>
                  <option value="10">10</option>
                </select><span class="title current-rating">Current rating: <span class="value digits"></span></span><span class="title your-rating hidden">Your rating: <span class="value digits"></span><a class="clear-rating" href="#"><i class="fa fa-times-circle"></i></a></span>
              </div>
            </div>
          </div>
        </div>
