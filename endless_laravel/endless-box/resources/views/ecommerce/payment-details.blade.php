...
@section('title', 'Payment Details | Endless Admin Panel')
@section('style')
      ...
      <div class="card height-equal">
        ...
        <div class="card-body">
          <form class="theme-form e-commerce-form row">
            ...
            <div class="col-12">
              <button class="btn btn-info-gradien btn-block" type="button" data-original-title="btn btn-info-gradien" title="">Submit</button>
            </div>
          </form>
        </div>
      </div>
