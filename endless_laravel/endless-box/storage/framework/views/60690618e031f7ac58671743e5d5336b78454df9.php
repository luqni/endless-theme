...
<?php $__env->startSection('title', 'Endless Box Dashboard | Endless - Premium Admin Template'); ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xl-8 xl-100 set-col-12">
      <div class="row">
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
    ...
    <div class="col-xl-4 xl-50 col-md-6 set-col-6">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
    ...
    <div class="col-xl-7 xl-100 set-col-12">
      <div class="card">
        <div class="card-header card-header-border">
          <div class="row">
            <div class="col-sm-6">
    ...
    <div class="col-xl-5 xl-100 set-col-12">
      <div class="card">
        <div class="card-header card-header-border">
          <div class="row">
            <div class="col-sm-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ekta/backup/html Theme/laravel endless/endless-box/resources/views/dashboards/dashboard-default.blade.php ENDPATH**/ ?>