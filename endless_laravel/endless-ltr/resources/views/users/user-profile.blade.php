...
@section('title', 'User Profile | Endless Admin Panel')
@section('styles')
          ...
          <div class="profile-img-style">
            ...
            <div class="img-container">
              <div class="my-gallery" id="aniimated-thumbnials">
                <figure itemprop="associatedMedia"><a href="{{asset('assets/images/other-images/profile-style-img3.png')}}" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img3.png')}}" itemprop="thumbnail" alt="gallery"></a>
        ...
        <div class="card">
          <div class="profile-img-style">
            ...
            <div class="row mt-4 pictures my-gallery" id="aniimated-thumbnials-2">
              <figure class="col-sm-6" itemprop="associatedMedia"><a href="{{asset('assets/images/other-images/profile-style-img3.png')}}" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img.png')}}" itemprop="thumbnail" alt="gallery"></a>
                <figcaption itemprop="caption description">Image caption  1</figcaption>
              </figure>
              <figure class="col-sm-6" itemprop="associatedMedia"><a href="{{asset('assets/images/other-images/profile-style-img3.png')}}" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img.png')}}" itemprop="thumbnail" alt="gallery"></a>
            ...
            <div class="row">
              <div class="col-lg-12 col-xl-4">
                <div class="my-gallery" id="aniimated-thumbnials-3">
                  <figure itemprop="associatedMedia"><a href="{{asset('assets/images/blog/img.png')}}" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="{{asset('assets/images/blog/img.png')}}" itemprop="thumbnail" alt="gallery"></a>
                    <figcaption itemprop="caption description">Image caption  1</figcaption>
                  </figure>
                </div>
