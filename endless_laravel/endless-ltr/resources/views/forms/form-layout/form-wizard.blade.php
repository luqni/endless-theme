...
@section('title', 'Form Wizard | Endless Admin Panel')
@section('styles')

@endsection

@section('breadcrumb-title', 'Form Wizard')
          ...
          <form class="form-wizard" id="regForm">
            ...
            <div class="tab">
              <div class="form-group">
                ...
                <input class="form-control digits" placeholder="dd-mm-yy" type="date">
              </div>
              <div class="form-group">
            ...
            <div class="tab">
              ...
              <div class="form-group">
                ...
                <input class="form-control mt-1" type="text" name="city" placeholder="City" required="required">
              </div>
            </div>
            <div>
            ...
            <!-- Circles which indicates the steps of the form:-->
            <span id="getRequestpost" style="font-size: 12px; color: blue; display: none;" >New Json data created. Now Download</span>
          </form>
        </div>
      </div>
    </div>
