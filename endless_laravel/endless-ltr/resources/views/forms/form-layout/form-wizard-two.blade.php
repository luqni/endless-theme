...
@section('title', 'Step Form Wizard | Endless Admin Panel')
@section('styles')

@endsection

@section('breadcrumb-title', 'Step Form Wizard')
              ...
              <div class="col-xs-12">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="date" placeholder="date" required="required">
                  </div>
                  <div class="form-group">
