...
@section('title', 'Tilt Animation | Endless Admin Panel')
@section('styles')

@endsection

@section('breadcrumb-title', 'Tilt Animation')
          ...
          <div class="row">
            <div class="col-md-6 offset-md-3">
              ...
              <div>
                ...
                <ul>
                  <li>
                    <div class="line"><code><span> <</span>script<span> src="tilt.jquery.js"></span><span><</span>/script<span>></span></code></div>
                  </li>
                  <li>
                    <div class="line">Mark your elements with<code><span> <</span>span<span> data-tilt"></span><span><</span>/span<span>></span></code></div>
                  </li>
                </ul>
              </div>
            </div>
