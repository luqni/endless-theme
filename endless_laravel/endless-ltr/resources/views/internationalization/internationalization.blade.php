...
@section('title', 'Internationalization | Endless Admin Panel')
@section('styles')

@endsection

@section('breadcrumb-title', 'Internationalization')
