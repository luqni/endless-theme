...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Add rows </h5><span>New rows can be added to a DataTable using the<code class="api" title="DataTables API method">row.add()</code> API method. Simply call the API function with the data for the new row (be it an array or object). Multiple rows can be added using the<code class="api" title="DataTables API method">rows.add()</code> method (note the plural). Data can likewise be updated with the <code class="api" title="DataTables API method">row().data()</code> and <code class="api" title="DataTables API method">row().remove()</code> methods.</span><span>Note that in order to see the new row in the table you must call the<code class="api" title="DataTables API method">draw()</code> method, which is easily done through the chaining that the DataTables API employs.</span>
        </div>
        <div class="card-body">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Row selection (multiple rows)</h5><span>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Row Selection And Deletion (Single Row)</h5><span>
            It can be useful to provide the user with the option to select rows in a DataTable. This can be done by using a click event to add / remove a class on the
            table rows. The <code class="api" title="DataTables API method">rows().data()</code>method can then
                                                  be used to get the data for the selected rows. In this case it is simply counting the number of selected rows, but much more complex interactions can easily be
                                                  developed.</span>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Show / Hide Columns Dynamically</h5><span>This example shows how you can make use of the <code class="api" title="DataTables API method">column().visible() </code> API method to dynamically show and hide columns in a table. Also included here is scrolling, just to show it enabled with this API method, although that is not required for the API function to work.</span>
        </div>
        <div class="card-body">
          <div class="table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h5>Search API (Regular Expressions)</h5><span>This example shows how you can make use of the <code class="api" title="DataTables API method">column().visible() </code> API method to dynamically show and hide columns in a table. Also included here is scrolling, just to show it enabled with this API method, although that is not required for the API function to work.</span>
        </div>
        <div class="card-body">
