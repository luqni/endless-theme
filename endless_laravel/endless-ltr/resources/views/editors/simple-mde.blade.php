...
@section('title', 'MDE Editor | Endless Admin Panel')
@section('styles')
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/simple-mde.css')}}">
@endsection

@section('breadcrumb-title', 'MDE Editor')
