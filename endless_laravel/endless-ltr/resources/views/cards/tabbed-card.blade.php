...
@section('title', 'Tabbed card | Endless Admin Panel')
@section('styles')

@endsection

@section('breadcrumb-title', 'Tabbed card')
  ...
  <div class="row">
        ...
        <div class="card-body">
          <div class="tabbed-card">
            <ul class="pull-right nav nav-tabs nav-material" id="top-tab" role="tablist">
              <li class="nav-item"><a class="nav-link" id="top-home-tab" data-toggle="tab" href="#top-home" role="tab" aria-controls="top-home" aria-selected="false">Home</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link active" id="profile-top-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true">Profile</a>
                <div class="material-border"></div>
              </li>
        ...
        <div class="card-body">
          <div class="tabbed-card">
            <ul class="pull-right nav nav-tabs nav-material" id="top-tab2" role="tablist">
              <li class="nav-item"><a class="nav-link" id="top-home-tab2" data-toggle="tab" href="#top-home2" role="tab" aria-controls="top-home" aria-selected="false"><i class="icofont icofont-ui-home"></i>Home</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link active" id="profile-top-tab2" data-toggle="tab" href="#top-profile2" role="tab" aria-controls="top-profile2" aria-selected="true"><i class="icofont icofont-man-in-glasses"></i>Profile</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link" id="contact-top-tab2" data-toggle="tab" href="#top-contact2" role="tab" aria-controls="top-contact2" aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a>
                <div class="material-border"></div>
              </li>
            </ul>
    ...
    <div class="col-xl-6 xl-100 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="tabbed-card">
            <ul class="pull-right nav nav-tabs nav-material nav-secondary" id="top-tabsecondary" role="tablist">
              <li class="nav-item"><a class="nav-link" id="top-home-secondary" data-toggle="tab" href="#top-homesecondary" role="tab" aria-controls="top-home" aria-selected="false"><i class="icofont icofont-ui-home"></i>Home</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link active" id="profile-top-secondary" data-toggle="tab" href="#top-profilesecondary" role="tab" aria-controls="top-profilesecondary" aria-selected="true"><i class="icofont icofont-man-in-glasses"></i>Profile</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link" id="contact-top-secondary" data-toggle="tab" href="#top-contactsecondary" role="tab" aria-controls="top-contactsecondary" aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a>
                <div class="material-border"></div>
              </li>
            </ul>
    ...
    <div class="col-xl-6 xl-100 col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="tabbed-card">
            <ul class="pull-right nav nav-tabs nav-material nav-success" id="top-tabdanger" role="tablist">
              <li class="nav-item"><a class="nav-link" id="top-home-danger" data-toggle="tab" href="#top-homedanger" role="tab" aria-controls="top-homedanger" aria-selected="false"><i class="icofont icofont-ui-home"></i>Home</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link active" id="profile-top-danger" data-toggle="tab" href="#top-profiledanger" role="tab" aria-controls="top-profiledanger" aria-selected="true"><i class="icofont icofont-man-in-glasses"></i>Profile</a>
                <div class="material-border"></div>
              </li>
              <li class="nav-item"><a class="nav-link" id="contact-top-danger" data-toggle="tab" href="#top-contactdanger" role="tab" aria-controls="top-contactdanger" aria-selected="false"><i class="icofont icofont-contacts"></i>Contact</a>
                <div class="material-border"></div>
              </li>
            </ul>
