...
Route::view('/', 'dashboards.default')->name('/');

Route::prefix('dashboard')->group(function () {  
  Route::view('/default', 'dashboards.default')->name('default');
  Route::view('/e-commerce', 'dashboards.e-commerce')->name('e-commerce');
  Route::view('/university', 'dashboards.university')->name('university');
  Route::view('/crypto', 'dashboards.crypto')->name('crypto');
  Route::view('/server', 'dashboards.server')->name('server');
